(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    _.each(array, function(el) {
      if (!valueTracker.hasOwnProperty(iterator(el))) {
        valueTracker[iterator(el)] = el;
      }
    });
    return Object.values(valueTracker);
  };
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    return accumulator;
    //return accumulator after every element in collection is iterated over
  };
  ...
  _.extend = function(obj) {
    ...
    var obj = arguments[0];
    _.each(args, function(el, index) {
      for (var k in args[index]) {
        obj[k] = args[index][k];
      }
    });
    return obj;
  ...
  _.shuffle = function(array) {
    ...
    for (var i = copyArr.length - 1; i <= 0; i--) {
      ...
      temp = copyArr[i];
      copyArr[i] = copyArr[randomNum];
      copyArr[randomNum] = temp;
    }
    return copyArr;
  };
